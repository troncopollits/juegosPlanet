 ...
 * @author artur
 */
public class ComentarioDao_2 extends GenericDaoImplementation implements DaoInterface {

    public ComentarioDao_2(Connection oConnection, String ob, UsuarioBean oUsuarioBeanSession) {
